<?php
class ControllerExtensionThemePavo extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('extension/theme/pavo');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/theme/pavo', 'user_token=' . $this->session->data['user_token'] . '&store_id=' . $this->request->get['store_id'], true)
		);

		$data['action'] = $this->url->link('extension/theme/pavo', 'user_token=' . $this->session->data['user_token'] . '&store_id=' . $this->request->get['store_id'], true);
		...
		$this->response->setOutput($this->load->view('extension/theme/pavo', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/theme/pavo')) {
